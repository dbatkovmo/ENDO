...
import { QUESTIONS } from './energy-quiz.data'
import type { AnswerOption } from './energy-quiz.types'
import styles from './EnergyQuiz.module.scss'

interface Props { onFinish: (answers: Record<string, AnswerOption>) => void }

export function EnergyQuiz({ onFinish }: Props) {
